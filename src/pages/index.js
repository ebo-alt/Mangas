...
export default function Home() {
  ...
  return (
    <main>
        <div className="font-montserrat w-full h-40 flex justify-between text-black dark:text-[#ddd] text-base">
          <img
            class="h-8 mt-8 ml-[5%]"
        ...
        <div>
        <h1 class="font-montserrat ml-10 text-[#ddd] text-xl">
          Гарч байгаа
        </h1>
        ...
        <h1 class="font-montserrat ml-10 text-[#ddd] text-xl mt-20">
          Дууссан
        </h1>
        <div class="grid xl:grid-cols-6 md:grid-cols-4 sm:grid-cols-2 gap-10 ml-10 mr-10 mt-6">
        <div>
